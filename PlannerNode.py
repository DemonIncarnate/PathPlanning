...
class PlannerNode:
    ...
    def heurisitc_value(self,tuple1,goalx,goaly):

        dx = abs((tuple1[0]-goalx))
        dy = abs((tuple1[1]-goaly))
        h = math.hypot(dx,dy)
        print(goalx)
        return h
    ...
    def wall_callback(self, map_detail):
        ...
        goalx = map_detail.end_x
        goaly = map_detail.end_y
        #print(goalx)
        ...
        if map_detail.current_value == 14:
            ...
            if u in closed_set and d not in closed_set_2:
                temp_val = direction()
                temp_val.direction = 'down'
                self.direction_publisher.publish(temp_val)
            else:
            ...
            if l in closed_set and r not in closed_set_2:
                temp_val = direction()
                temp_val.direction = 'right'
                self.direction_publisher.publish(temp_val)
            else:
            ...
            if r in closed_set and d not in closed_set_2:
                temp_val = direction()
                temp_val.direction = 'down'
                self.direction_publisher.publish(temp_val)
            else:
            ...
            if l in closed_set and d not in closed_set_2:
                temp_val = direction()
                temp_val.direction = 'down'
                self.direction_publisher.publish(temp_val)
            else:
            ...
            if u in closed_set and r not in closed_set_2:
                temp_val = direction()
                temp_val.direction = 'right'
                self.direction_publisher.publish(temp_val)
            else:
            ...
            if l in closed_set and u not in closed_set_2:
                temp_val = direction()
                temp_val.direction = 'up'
                self.direction_publisher.publish(temp_val)
            else:
            ...
            if u in closed_set:
                h1 = self.heurisitc_value(r,goalx,goaly)
                h2 = self.heurisitc_value(d,goalx,goaly)
                ...
                h1 = self.heurisitc_value(u,goalx,goaly)
                h2 = self.heurisitc_value(d,goalx,goaly)
                ...
                h1 = self.heurisitc_value(u,goalx,goaly)
                h2 = self.heurisitc_value(r,goalx,goaly)
            ...
            if l in closed_set:
                ...
                h1 = self.heurisitc_value(l,goalx,goaly)
                h2 = self.heurisitc_value(d,goalx,goaly)
            ...
            if l in closed_set:
                ...
                h1 = self.heurisitc_value(l,goalx,goaly)
                h2 = self.heurisitc_value(u,goalx,goaly)
                if h1 < h2 and l not in closed_set_2:
            ...
            if l in closed_set:
                h1 = self.heurisitc_value(r,goalx,goaly)
                h2 = self.heurisitc_value(d,goalx,goaly)
                h3 = self.heurisitc_value(u,goalx,goaly)
                a = min(h1,h2,h3)
                if (a ==  h1 and r not in closed_set_2) or ((a == h2 and d in closed_set_2) or (a == h3 and u in closed_set_2)):

                    temp_val = direction()
                    temp_val.direction = 'right'
                    self.direction_publisher.publish(temp_val)
                elif (a == h2 and d not in closed_set_2) or (a == h3 and u in closed_set_2):
                    temp_val = direction()
                    temp_val.direction = 'down'
                    self.direction_publisher.publish(temp_val)
                else:
                ...
                h1 = self.heurisitc_value(l,goalx,goaly)
                h2 = self.heurisitc_value(r,goalx,goaly)
                h3 = self.heurisitc_value(d,goalx,goaly)
                a = min(h1,h2,h3)
                if a == h1 and l not in closed_set_2:
